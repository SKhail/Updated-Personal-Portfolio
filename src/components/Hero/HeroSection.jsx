            ...
            <div className='bg-gray-50' id='about'>
              <div className='container flex flex-col items-center py-16 md:py-20 lg:flex-row'>
                <div className='w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left'>
                  <h2 className='font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl'>SKILLS</h2>
                  <h4 className='pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl'>My Toolbox & Things I Can Do</h4>
