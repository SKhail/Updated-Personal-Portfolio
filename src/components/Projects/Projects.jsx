...
const projects = [
  ...
  },
  {
    ...
    title: 'Movie Quest',
    description:
      'Movie-Quest users can easily search for the movie that they are interested to know more information. This was built with a team four for experience movie enthusiasts.',
    link: { MovieQuest },
...
const Projects = () => {
  return (
    <div id='projects' className='py-2 bg-gray-100 dark:bg-gray-900'>
      <div className='container mx-auto px-4'>
        <div className='mb-5 text-center'>
          <h2 className='text-3xl font-bold text-gray-800 md:text-4xl dark:text-white'>A Variety Of Things I've Built</h2>
          <p className='py-2 lg:mx-auto lg:w-6/12 text-gray-600 dark:text-gray-300'>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className='flex flex-col items-center'>
                ...
                <p className='mt-2 mb-8 text-center text-gray-600 dark:text-white'>{project.description}</p>
